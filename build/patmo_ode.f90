...
contains
  subroutine fex(neq,tt,nin,dy)
    ...
    dn(:,patmo_idx_COS) = &
        ...
        - krate(:,38)*n(:,patmo_idx_COS)*n(:,patmo_idx_O_1D) &
        - krate(:,39)*n(:,patmo_idx_COS)*n(:,patmo_idx_O_1D) &
        - krate(:,40)*n(:,patmo_idx_COS) &
        + krate(:,48)*n(:,patmo_idx_CO2)*n(:,patmo_idx_SH) &
        + krate(:,49)*n(:,patmo_idx_CO)*n(:,patmo_idx_SO) &
        - krate(:,50)*n(:,patmo_idx_SH)*n(:,patmo_idx_COS) &
        - krate(:,52)*n(:,patmo_idx_COS)*n(:,patmo_idx_O) &
        - krate(:,53)*n(:,patmo_idx_COS)*n(:,patmo_idx_O2) &
        + krate(:,85)*n(:,patmo_idx_CO)*n(:,patmo_idx_SO) &
        + krate(:,86)*n(:,patmo_idx_S)*n(:,patmo_idx_CO2)
    ...
    !    + krate(:,58)*n(:,patmo_idx_H2O)*n(:,patmo_idx_HSO) &
    !    + krate(:,69)*n(:,patmo_idx_OH)*n(:,patmo_idx_SO3) &
    !    - krate(:,73)*n(:,patmo_idx_HO2)*n(:,patmo_idx_SO2) &
    !    - krate(:,74)*n(:,patmo_idx_HO2)*n(:,patmo_idx_SO3)

    dn(:,patmo_idx_NO) = 0d0
    !    + krate(:,18)*n(:,patmo_idx_SO)*n(:,patmo_idx_NO2) &
    !    - krate(:,65)*n(:,patmo_idx_SO2)*n(:,patmo_idx_NO)

    dn(:,patmo_idx_N) = 0d0
    !    + krate(:,33)*n(:,patmo_idx_N2) &
    !    + krate(:,33)*n(:,patmo_idx_N2) &
    !    - krate(:,80)*n(:,patmo_idx_N)*n(:,patmo_idx_N) &
    !    - krate(:,80)*n(:,patmo_idx_N)*n(:,patmo_idx_N)
    ...
    dn(:,patmo_idx_HSO) = &
        ...
        - krate(:,58)*n(:,patmo_idx_H2O)*n(:,patmo_idx_HSO) &
        - krate(:,61)*n(:,patmo_idx_HSO)*n(:,patmo_idx_O2) &
        + krate(:,71)*n(:,patmo_idx_SO2)*n(:,patmo_idx_OH) &
        + krate(:,72)*n(:,patmo_idx_O2)*n(:,patmo_idx_O2)*n(:,patmo_idx_SH)
    ...
    dn(:,patmo_idx_SO3) = &
        ...
        - krate(:,44)*n(:,patmo_idx_SO3) &
        - krate(:,69)*n(:,patmo_idx_OH)*n(:,patmo_idx_SO3) &
        - krate(:,70)*n(:,patmo_idx_SO3)*n(:,patmo_idx_O2) &
        - krate(:,74)*n(:,patmo_idx_HO2)*n(:,patmo_idx_SO3) &
        - krate(:,75)*n(:,patmo_idx_SO3) &
    ...
    !    + krate(:,11)*n(:,patmo_idx_H2S)*n(:,patmo_idx_HO2) &
    !    - krate(:,30)*n(:,patmo_idx_SO3)*n(:,patmo_idx_H2O) &
    !    - krate(:,55)*n(:,patmo_idx_H2O)*n(:,patmo_idx_SH) &
    !    - krate(:,58)*n(:,patmo_idx_H2O)*n(:,patmo_idx_HSO) &
    !    + krate(:,77)*n(:,patmo_idx_H2SO4)

    dn(:,patmo_idx_O_1D) = 0d0
    !    - krate(:,38)*n(:,patmo_idx_COS)*n(:,patmo_idx_O_1D) &
    !    - krate(:,39)*n(:,patmo_idx_COS)*n(:,patmo_idx_O_1D) &
    !    + krate(:,85)*n(:,patmo_idx_CO)*n(:,patmo_idx_SO) &
    !    + krate(:,86)*n(:,patmo_idx_S)*n(:,patmo_idx_CO2)
    ...
    !    + krate(:,40)*n(:,patmo_idx_COS) &
    !    - krate(:,49)*n(:,patmo_idx_CO)*n(:,patmo_idx_SO) &
    !    - krate(:,54)*n(:,patmo_idx_CO)*n(:,patmo_idx_S) &
    !    - krate(:,85)*n(:,patmo_idx_CO)*n(:,patmo_idx_SO)
    ...
    !    + krate(:,41)*n(:,patmo_idx_O3) &
    !    - krate(:,42)*n(:,patmo_idx_O2) &
    !    + krate(:,52)*n(:,patmo_idx_COS)*n(:,patmo_idx_O) &
    !    - krate(:,53)*n(:,patmo_idx_COS)*n(:,patmo_idx_O2) &
    !    + krate(:,60)*n(:,patmo_idx_OH)*n(:,patmo_idx_SO) &
    !    - krate(:,61)*n(:,patmo_idx_HSO)*n(:,patmo_idx_O2) &
    !    - krate(:,62)*n(:,patmo_idx_SO2)*n(:,patmo_idx_O2) &
    !    + krate(:,63)*n(:,patmo_idx_SO2)*n(:,patmo_idx_O) &
    !    + krate(:,66)*n(:,patmo_idx_SO)*n(:,patmo_idx_O) &
    !    - krate(:,67)*n(:,patmo_idx_O2)*n(:,patmo_idx_SO) &
    !    - krate(:,70)*n(:,patmo_idx_SO3)*n(:,patmo_idx_O2) &
    !    + krate(:,71)*n(:,patmo_idx_SO2)*n(:,patmo_idx_OH) &
    !    - krate(:,72)*n(:,patmo_idx_O2)*n(:,patmo_idx_O2)*n(:,patmo_idx_SH) &
    !    - krate(:,72)*n(:,patmo_idx_O2)*n(:,patmo_idx_O2)*n(:,patmo_idx_SH) &
    ...
    dn(:,patmo_idx_CS2) = &
        ...
        - krate(:,43)*n(:,patmo_idx_CS2) &
        + krate(:,50)*n(:,patmo_idx_SH)*n(:,patmo_idx_COS) &
        + krate(:,51)*n(:,patmo_idx_CS)*n(:,patmo_idx_SO)
    ...
    dn(:,patmo_idx_SO) = &
        ...
        + krate(:,38)*n(:,patmo_idx_COS)*n(:,patmo_idx_O_1D) &
        + krate(:,45)*n(:,patmo_idx_SO2) &
        - krate(:,47)*n(:,patmo_idx_SO) &
        - krate(:,49)*n(:,patmo_idx_CO)*n(:,patmo_idx_SO) &
        - krate(:,51)*n(:,patmo_idx_CS)*n(:,patmo_idx_SO) &
        - krate(:,59)*n(:,patmo_idx_H)*n(:,patmo_idx_SO) &
        - krate(:,60)*n(:,patmo_idx_OH)*n(:,patmo_idx_SO) &
        + krate(:,62)*n(:,patmo_idx_SO2)*n(:,patmo_idx_O2) &
        + krate(:,63)*n(:,patmo_idx_SO2)*n(:,patmo_idx_O) &
        + krate(:,64)*n(:,patmo_idx_SO2)*n(:,patmo_idx_H) &
        + krate(:,65)*n(:,patmo_idx_SO2)*n(:,patmo_idx_NO) &
        - krate(:,66)*n(:,patmo_idx_SO)*n(:,patmo_idx_O) &
        - krate(:,67)*n(:,patmo_idx_O2)*n(:,patmo_idx_SO) &
    ...
    !    + krate(:,50)*n(:,patmo_idx_SH)*n(:,patmo_idx_COS) &
    !    + krate(:,55)*n(:,patmo_idx_H2O)*n(:,patmo_idx_SH) &
    !    - krate(:,56)*n(:,patmo_idx_OH)*n(:,patmo_idx_SH) &
    !    - krate(:,60)*n(:,patmo_idx_OH)*n(:,patmo_idx_SO) &
    !    + krate(:,64)*n(:,patmo_idx_SO2)*n(:,patmo_idx_H) &
    !    + krate(:,68)*n(:,patmo_idx_H)*n(:,patmo_idx_SO) &
    !    - krate(:,69)*n(:,patmo_idx_OH)*n(:,patmo_idx_SO3) &
    !    - krate(:,71)*n(:,patmo_idx_SO2)*n(:,patmo_idx_OH) &
    !    + krate(:,76)*n(:,patmo_idx_HSO3) &
    !    - krate(:,78)*n(:,patmo_idx_SO2)*n(:,patmo_idx_OH)*n(:,patmo_idx_OH) &
    !    - krate(:,78)*n(:,patmo_idx_SO2)*n(:,patmo_idx_OH)*n(:,patmo_idx_OH) &
    !    + krate(:,83)*n(:,patmo_idx_SO2) &
    !    + krate(:,84)*n(:,patmo_idx_SO2)*n(:,patmo_idx_CH4O3S)
    ...
    !    - krate(:,57)*n(:,patmo_idx_H2)*n(:,patmo_idx_SH)
  ...
  !dry deposition
    ...
    dn(1,patmo_idx_CH3SCH3) = dn(1,patmo_idx_CH3SCH3) - 7.940d-6*n(1,31)    !DMS  lifetime 0.5d


  !aerosol formation

   do i=13,34
      if (va(i) <= n(i,25) .and. pa(i) >= n(i,25)) then
	   dn(i,patmo_idx_H2SO4) = dn(i,patmo_idx_H2SO4)- (n(i,25)-va(i))
       dn(i,patmo_idx_SO4) = dn(i,patmo_idx_SO4)+ (n(i,25)-va(i))
      end if
   end do
 ...
 !DMS → SO2 (96%)
  ! do i=1,60
  !     dn(i,patmo_idx_CH3SCH3) = dn(i,patmo_idx_CH3SCH3)- (n(i,31)*0.96d0)
  !     dn(i,patmo_idx_SO2) = dn(i,patmo_idx_SO2)+ (n(i,31)*0.96d0)
  ! end do
! end if
