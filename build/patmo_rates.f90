...
contains
 ...
 open(63,file="DMS_OH_rate.txt",status="old")
    ...
    do icell=1,cellsNumber
      ...
      !H2S + OH -> H2O + SH
      krate(icell,8) = 3.30d-12*exp(100/T)
      ...
      !SO + OH -> SO2 + H
      krate(icell,17) = 2.60d-11*exp(330/T)

      !SO + NO2 -> SO2 + NO
      krate(icell,18) = 0d0

      !S + O2 -> SO + O
      krate(icell,19) = 1.6d-12*exp(100/T)
      ...
      !COS + O(1D) -> CO + SO
      krate(icell,38) = 4.78d-11*T**(0.24)*exp(25.17/T)
      !krate(icell,38) = 2.04d-10

      !COS + O(1D) -> S + CO2
      krate(icell,39) = 3.51d-11*T**(0.30)*exp(156.08/T)
      !krate(icell,39) = 3.27d-10
